import 'package:mplanner/healthCal/functions/bodyFat.dart';
...
class BodyFatInputPage extends StatefulWidget {
  @override
  BodyFatInputPageState createState() {
    return new BodyFatInputPageState();
  }
}

class BodyFatInputPageState extends State<BodyFatInputPage>
    with TickerProviderStateMixin {
  final _controller = BodyFat();
              ...
              Flexible(
                ...
                child: Observer(
                  builder: (_) => SliderCard(
                    minValue: 1,
                    small: true,
                    inputValue: _controller.age,
                    onChanged: (val) => _controller.changeAge(val),
                    title: 'AGE',
                  ),
                ),
              ),
...
class InputSummaryCard extends StatelessWidget {
  ...
  const InputSummaryCard(
      {Key key, this.gender, this.height, this.weight, this.age})
      : super(key: key);
