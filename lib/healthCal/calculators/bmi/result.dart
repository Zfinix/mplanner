        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: IconButton(
              ...
              onPressed: () {
               // Share.text('Hi ', 'My current BMI is: ${calculator.calculateBMI(height: widget.height, weight: widget.weight).toStringAsFixed(2)} kg/m². Checkout https://healthkonnet.com.ng', 'text/plain');
